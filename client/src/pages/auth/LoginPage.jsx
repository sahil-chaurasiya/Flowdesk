      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 p-10 relative overflow-hidden">
        ...
        <div className="relative">
          <Link to="/" className="flex items-center gap-2.5 mb-12 group">
            ...
            <span className="text-white font-bold text-lg">To Fly Media</span>
          </Link>
          ...
          <p className="text-slate-400 text-sm leading-relaxed">
            Track leads, review reports, see your team's progress, and message us — all through your private portal.
          </p>
        </div>
        <div className="relative">
          <div className="grid grid-cols-2 gap-3 text-xs text-slate-400">
            {['🎯 Lead Tracking', '📊 Live Reports', '✅ Task Updates', '💬 Direct Chat'].map(f => (
              <div key={f} className="flex items-center gap-1.5">{f}</div>
            ))}
          </div>
          <div className="mt-6 text-xs text-slate-500">© {new Date().getFullYear()} To Fly Media</div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="flex items-center gap-2.5 mb-8 lg:hidden">
            ...
            <span className="text-slate-800 font-bold">To Fly Media</span>
          </div>

          <div className="mb-8">
            <h1 className="text-2xl font-black text-slate-900">Sign in</h1>
            <p className="text-slate-500 text-sm mt-1">Access your portal or team dashboard</p>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-slate-400">
            Not a client yet?{' '}
            <a href="/" className="text-brand-600 hover:underline">Learn about To Fly Media</a>
          </p>

          {/* Demo hint */}
          <div className="mt-8 p-4 bg-slate-50 border border-slate-200 rounded-xl">
            <div className="text-xs font-semibold text-slate-600 mb-2">Demo Accounts</div>
            <div className="space-y-1 text-xs text-slate-500">
              <div><span className="font-medium text-slate-700">Project Manager:</span> manager@toflymedia.com</div>
              <div><span className="font-medium text-slate-700">Performance Marketer:</span> marketer@toflymedia.com</div>
              <div><span className="font-medium text-slate-700">Video Editor:</span> editor@toflymedia.com</div>
              <div><span className="font-medium text-slate-700">Client:</span> client@toflymedia.com</div>
              <div className="text-slate-400 mt-1">All passwords: <span className="font-mono">*Role*123!</span></div>
            </div>
          </div>
        </div>
      </div>
